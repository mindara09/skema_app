<div>
	...
	<div class="card">
		<div class="card-body">	
			...
			@include('livewire.admin.promotion-products.create')
			@include('livewire.admin.promotion-products.update')
            ...
            <table class="table">
            	...
            	<tbody>
            		...
            		<tr>
	            		...
	            		<td>{{ str_replace(array('"','[',']'), ' ', $product->where('id', $item->product_id)->pluck('name_product'))}}</td>
	            		<td>{{ $item->discount }} </td>
	            		<td>
