...
<body id="page-top" onload="waktu()">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav text-dark sidebar sidebar-dark accordion toggled" id="accordionSidebar" style="background-color: white;">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="{{ asset('/img/logo-skema.png')}}" class="img-responsive" width="30" height="30">
                </div>
            </a>
            ...
            <!-- Nav Item - Orders -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{ url('/dashboard/orders')}}">
            ...
            <!-- Nav Item - Categories -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{ url('/dashboard/categories')}} ">
                    <i class="fas fa-fw fa-th-list text-dark"></i>
                    <span>Categories</span></a>
            </li>

            <!-- Nav Item - Products -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{ url('/dashboard/products')}}">
                    <i class="fas fa-fw fa-th-large text-dark"></i>
                    <span>Products</span></a>
            </li>

            <!-- Nav Item - Customers -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{ url('/dashboard/customers')}}">
            ...
            <!-- Nav Item - Users -->
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{ url('/dashboard/users')}}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SKEMA 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
